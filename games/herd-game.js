...
function startcow(form) {
    ...
    for(let i = 0; i< form.anzspieler.value; i++){
        document.getElementById("cowspieler").innerHTML += '<button class="btn btn-outline-dark col-6 col-sm-4 col-lg-3" onclick="getpoints('+(i)+ ')" id="cow'+i+ '"><h2 id="hascow'+(i)+ '"></h2><h3>Spieler '+(i+1)+ '<br> Punkte: <div id="pnkt-'+(i)+ '">0</div></h3></button>\n'
